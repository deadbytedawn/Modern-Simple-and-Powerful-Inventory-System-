...
namespace InventorySystem
{
    ...
    public class InventoryUIManager : MonoBehaviour
    {
        ...
        {
            // replace with new inputsystem if possible, but for now this allows for quick access to slots through button presses. It also allows for quick deselection of slots by clicking the mouse, which is a common convention in inventory systems.
            ...
            {
                string input = InputSystem.onAnyButtonPress.ToString();
